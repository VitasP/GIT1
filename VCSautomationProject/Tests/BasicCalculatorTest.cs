...
namespace VCSautomationProject.Tests
{
    class BasicCalculatorTest
    {
        ...
        public static void TestSumBlock(string firstInputValue, string secondInputValue, bool shouldBeChecked, string result)
        {
            ...
            basicCalculatorPage.EnterSecondInputValue(secondInputValue);
            basicCalculatorPage.CheckIfIntegersOnly(shouldBeChecked);
            basicCalculatorPage.ClickCalculateButton();
            basicCalculatorPage.VerifyResult(result);
